...
* [我要做什么来索引SWF...](#section_0A6A52CC70D4495BBE14D91906318F95)
...
## 为SWF文件编制索引时必须做什么？{#section_0A6A52CC70D4495BBE14D91906318F95}

要对SWF文件进行爬网和索引，请选择内容类型&#x200B;**[!UICONTROL Adobe Flash Movies]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)。
...
SWF文件也可以用`application/octet-stream`&quot;或`text/plain` MIME类型识别，前提是文件扩展名为.swf。
...
要防止对SWF文件进行索引，可以向封闭的HTML文档添加robots meta标签(`<meta name="ROBOTS" content="NOINDEX">`)或`<noindex>`标签。 即包含`<embed>`或`<object>`标签的文档。
...
请参阅[将URL蒙版添加到……的索引部分或不是索引部分……](../c-about-settings-menu/c-about-crawling-menu.md#task_E1AFC17C746048B8843013D979E082C1)。
...
网站搜索/促销从使用AdobeFlash创建的SWF文件获取UTF-8。 UTF-8不包含任何语言指示。 如果选择了内容类型&#x200B;**[!UICONTROL Adobe Flash Movies]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定SWF文件使用的语言。

请参阅[添加字段注入定义](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)。

旧版SWF文件也不指定字符集。 如果选择了SWF内容类型&#x200B;**[!UICONTROL Adobe Flash Movies]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定SWF文件中使用的字符集。
...
* [当我的站点超出页面限制时，会出现什么情况？](#section_ECA5FA01032D4322BABA4E2C7FE498C1)
...
* [能否在搜索中显示我自己的横幅广告……](#section_611EB8B32C16418386CB7DC7FB6954B8)

以下是有关搜索功能的常见问题：

* [是否可以自定义网站的搜索结果？](#section_A64B3A621B794DF78D35ED06D9C43D0B)
* [能否看到客户在我的……](#section_73709E1B0E82478DA7B4D15B6C845F33)
* [我如何控制哪些内容类型(PDF、文本、Flash、MP3和Microsoft Office)被索引和搜索？](#section_0AB8CB4B6BFA4286AA082055FEBFBE1C)
...
* [我能在我的Adobe上拥有多个站点吗……](#section_AFA8825182094660A71EEC84B8329D6D)
* [是否可以搜索多个域？](#section_BFBB0E9861D942F095B56CF0A8F16596)
* [能否将我的网站细分为不同的部分……](#section_52153A9DE9F9493B967A70583848B2A4)
* [如何排除我网站的某些部分……](#section_D452EDE153654EF398F4A87780C6D43B)
* [支持哪些字符集？](#section_A62A6F8F15804F968C77F2DEBDE8F8FD)
* [如果我更改或更新我的网站会怎样？](#section_489050E0EBC14D0594DBBAA0CCF4F6BA)
* [是否可以自动索引我的网站？](#section_9C7D41636238488691ECDFEE4D4E5103)
* [我在我的网站上使用密码。我是否仍能使用网站搜索/促销？](#section_4618EB5B66704640B5502D1B5CB4B32E)
* [是否支持搜索和索引https或……](#section_D5BB8B8FBEA4405583E86B4AEC37151B)
* [网站搜索/促销是否遵守我网站上的robots.txt文件？](#section_73BBF6FE93C64C109F45CBC2FA394DB2)
* [我网站的某些部分必须经常更新，因此……](#section_6D2FB1DE1B8A49729F9CCAE2A2770AB3)
* [我是否可以使用脚本或项目来启动增量……](#section_0B6BB039557A42AA876D35D748E17DD0)

## 是否必须安装任何软件才能使用网站搜索/促销？{#section_02AB2AFF71984F9DAA3AF2B7C0847A22}
...
请参阅[查看实时或分阶段的完整索引日志……](../c-about-index-menu/c-about-full-index.md#task_02E5E944C56B4EB19CC1FF321F3221B8)。

## 如何更改发送每周报告的电子邮件地址？{#section_AE27F63DD13F425B940C8E7D9ED5C614}

每周报告将发送给每个活动帐户的所有者。 可以通过单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]**&#x200B;来更改电子邮件地址。 如果您有多个活动的搜索帐户，则所有新闻稿都会发送到新地址。
...
## 能否在搜索结果页面上显示我自己的横幅广告？{#section_611EB8B32C16418386CB7DC7FB6954B8}
...
这些设置在[!DNL Staged Content Types]页面上受控。
...
搜索自动机从[!DNL Account Settings]中指定的网站地址的第一页开始，对您的网站进行爬网，并跟踪从页面到页面的链接。
...
例如，假设您的网站上有一个页面包含要销售的产品的价格列表。 但是，在检查网站搜索/销售提供的搜索报表后，您会发现客户在搜索中查找“成本”、“费用”、“费用”或“费用”。 这些词不会在搜索结果中显示您的价格列表页。 使用[!DNL Dictionaries]中的[!DNL Add Synonyms]功能，您可以指定这些单词都是同义词，而且您的客户可以找到您的价格列表，而不管他们使用哪个搜索词。
...
## 是否可以更改搜索结果页面的语言？{#section_6EE41DA8241247D48BBEB061A50599C5}
...
## 我是否可以在我的Adobe客户登录中拥有多个站点？{#section_AFA8825182094660A71EEC84B8329D6D}
...
## 能否将我的网站细分为单独的部分，以便客户可以单独或整个网站搜索其中任何区域？{#section_52153A9DE9F9493B967A70583848B2A4}
...
要防止搜索单个网页的部分，可以从索引中排除页面的部分。 用`<noindex>`和`</noindex>`标签环绕文本。 如果要从搜索中排除导航文本，则此方法很有用。
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>鲍尔蒂克语(ISO-8859-4) </p> </td> 
   <td colname="col2"> <p>西里尔语(ISO-8859-5) </p> </td> 
   <td colname="col3"> <p>南欧语(ISO-8859-3) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>鲍尔蒂克语(Windows-1257) </p> </td> 
...
## 是否支持对https或安全服务器内容进行搜索和索引？{#section_D5BB8B8FBEA4405583E86B4AEC37151B}
...
## 我是否可以使用脚本或项目来启动网站的增量索引？{#section_0B6BB039557A42AA876D35D748E17DD0}
...
一个常见问题解答页，讨论[!DNL Search&Promote]中的各种功能实现。

以下是有关网站[!DNL Search&Promote]中功能实现的常见问题：
...
网站可能会不断增长，并且随着时间的推移，Search&amp;Promote会“发现”更多已添加的文档和网页。 最终，您的帐户可能会超出您的索引大小限制。在这种情况下，您可以考虑使用&#x200B;**[!UICONTROL URL Mask]**。 此功能可隐藏文档和网页，使其不需要或不需要索引的索引搜索，从而缩小索引大小。 另一种选择是与技术支持联系，使您的索引大小限制在您的帐户中设置得更大。
...
* [我是否可以对Unicode、UTF-8、编码页面使用站点搜索/促销？](#section_130997CB08934A13A5261D85CF88040C)
...
* [我需要做点特别的事情……](#section_A8BA6DDD3A6048319D3530BCFD6DA1A5)
* [为什么在Netscape 4.7及更早版本的搜索结果中显示中文、日文或韩文字体？](#section_DF42567063304F918D406AC76529DFB7)
...
此代码行告诉搜索引擎传入的查询是使用iso-8859-1编码的，这是西欧语言的常用编码。 您可以通过转到产品菜单并单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]**&#x200B;来更改此设置。 在[!DNL Personal Information]页面的&#x200B;**[!UICONTROL Character Encoding]**&#x200B;下拉列表中，选择新编码。

请参阅[配置您的个人用户信息](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6)。

您还可以通过编辑搜索表单的`sp_f`行手动更改网页上的编码值。 请记住，搜索表单的`sp_f`值必须与显示该表单的页面的字符集编码匹配。
...
网站搜索/促销从Adobe PDF文件获取UTF-8，而不显示任何语言。 如果选择&#x200B;**[!UICONTROL PDF Documents]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定PDF文件中使用的语言。

请参阅[添加字段注入定义](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)。

## 为什么我无法在我的网站上搜索中文、日文或韩文SWF文件？{#section_9C0849528AFF4C10AA97A2C912992638}

网站搜索/促销从使用Adobe Flash创建且没有语言指示的Adobe Flash电影文件中获取UTF-8。 如果选择了内容类型&#x200B;**[!UICONTROL Adobe Flash Movies]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定SWF文件中使用的语言。

对于Flash版本4或更早版本的SWF文件，不指定文件中字符的字符集。 如果选择了内容类型&#x200B;**[!UICONTROL Adobe Flash Movies]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定SWF文件中使用的字符集。

请参阅[添加字段注入定义](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)。

## 为什么我无法在我的网站上搜索中文、日文或韩文Microsoft Office文件？{#section_6764BA6863AF492EBA9BE5CCC12CDD1F}

网站搜索/促销从Microsoft Office文件（Microsoft Word、Microsoft Excel和Microsoft PowerPoint）获得UTF-8，而不显示任何语言。 如果选择了内容类型&#x200B;**[!UICONTROL Microsoft Office Files]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定Microsoft Office文件中使用的语言。
...
## 我是否需要执行任何特殊操作才能在我的网站上获取正确索引的.txt文件？{#section_A8BA6DDD3A6048319D3530BCFD6DA1A5}
...
如果您的帐户使用默认模板、一个随时可用的模板或基于任何这些模板的模板，则其中可能包含将Arial或Helvetica指定为字体的字体标签。 例如，`<font face="arial, helvetica" size="+1">`。当使用Arial或Helvetica字体时，Netscape 4.7及早期版本不显示中文、日文或韩文字符。 删除`face`属性，或将字体替换为更适合中文、日文或韩文的字体。

## 低页数{#reference_4344E3E3CB2948939860F8C078BD7773}

一个常见问题页，讨论与低索引页面计数相关的常见问题。

以下是有关低索引页面计数的常见问题：

* [你检查过你的索引日志吗？](#section_D6626536DC3D40DDA4A1224F1CB276BF)
...
* [您的HTML注释标签是否格式不正确……](#section_D1C39D79341845CB9C38579AABDF3A24)
* [您的网页是否包含指向其他网页的链接……](#section_F8082759184049AAA8FA6342C1F84389)
...
在产品菜单上，单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**。 在[!DNL Staged URL Entrypoints]页面上，验证以下内容：
...
## 您网站上其他页面的链接是否嵌入JavaScript?{#section_EE34A67D60A844EBB0921C03544FF63E}
...
另一种解决方案是将网站上其他页面的URL列表为入口点以进行爬网和索引。 URL以`https://`开头，如下所示：
...
HTML规范要求`<html>`、`<head>`和`<body>`标签遵循HTML文档中的特定序列。 所有网页中的标记必须具有以下顺序：
...
在这种情况下，请将`<html>`、`<head>`和`<body>`标签放入网页中的相应序列中。

## 您的网页中是否有错误的HTML注释标签？{#section_D1C39D79341845CB9C38579AABDF3A24}
...
## 您的网页是否包含指向其他域上的页面的链接？{#section_F8082759184049AAA8FA6342C1F84389}
...
在产品菜单上，单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**。 添加您网站的“主网站入口点”URL。 然后，将其他URL入口点添加到包含网页的任何其他域。 例如，您应将主URL入口点设置为：
...
在产品菜单上，单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**。 将“主网站URL入口点”添加到站点的虚拟域名。 然后，将其他入口点添加到网站实际所在的域。
...
在产品菜单上，单击&#x200B;**[!UICONTROL Settings]** >爬网> **[!UICONTROL URL Entrypoints]**。 将另一个入口点添加到meta refresh标记的URL。
...
* [未在Microsoft Office文件中编入索引的内容……](#section_BD53BDABFDD94D7EB0E1F55EC18017BB)
...
## 哪些内容未在Microsoft Office文件中编入索引？{#section_BD53BDABFDD94D7EB0E1F55EC18017BB}
...
如果不希望搜索自动机对Microsoft Office文件进行爬网和索引，请取消选择内容类型&#x200B;**[!UICONTROL Microsoft Office Files]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)。
...
## 如何爬网和索引站点上的MP3文件？{#section_3CD794446E3545379C14E9F222118665}
...
* [哪些内容在PDF文件中编入索引？](#section_62BFCD7158B44F2BB3B1864224B50174)
* [哪些内容不在PDF文件中编入索引？](#section_A14B353AE503408896BACBBF3F748FA0)
* [索引PDF文件如何计数？](#section_C35DE36A65D649BD8FF314E9EFD990A6)
* [搜索结果能否显示PDF图标？](#section_829CE82CC3544502A13D27C4DB820189)
* [搜索结果是否链接到中的特定页面？](#section_A06E7F7017E6441E98209D288EE57BF6)
...
网站搜索/促销从没有语言指示的PDF文件获取UTF-8。 如果选择了内容类型&#x200B;**[!UICONTROL PDF Documents]**(**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)，则必须使用元数据注入指定PDF文件中使用的语言。
...
* [您的服务器是否启用了目录浏览？](#section_073C88EEE74F4CA0AD2C7145D4810B22)
...
请参阅[查看实时或……的脚本增量索引日志](../c-about-index-menu/c-about-scripted-index.md#task_CBFCE9B9A87B4DF7A2A35A6E83DE93D7)。

请参阅[查看实时或已暂存的已重新生成索引日志……](../c-about-index-menu/c-about-regenerate-index.md#task_61CE8F9E7BF84BA89A8D482B2106BB15)。

请参阅[查看实时或分阶段网站的重排索引日志](../c-about-index-menu/c-about-re-rank-index.md#task_3C76107DFAC1495FACD3ABB0A688208D)。

## CGI项目是否正在您的网站上编制索引？{#section_86ED8A641B3841EC80153B4F107548FD}

CGI项目使用URL参数，这些参数有时会导致索引器爬网多个“假”URL。 如果网站搜索/促销正在读取您的CGI项目，并在其中使用CGI参数的URL后，可能有数倍的页面正在被爬网和索引，这对您的搜索索引来说并不有用。 典型CGI参数显示在具有`?`或`&`字符的URL中。
...
当Web服务器启用了目录浏览且给定目录中没有index.html文件时，访问该目录可显示该目录中的文件列表。 通常，页面顶部有链接，您只需单击&#x200B;**[!UICONTROL Name]**、**[!UICONTROL Last modified]**、**[!UICONTROL Size]**&#x200B;等，即可通过不同方式对列表进行排序。 通常，这些URL在网站搜索/促销索引日志中以URL的形式显示，其末尾为`?M=A`等字符。 网站搜索/促销索引器将这些链接作为链接，这可能导致为多个“假”URL建立索引。

通常，设计良好的网站要么在每个目录中都有索引文件，要么对那些没有索引文件的目录禁用了目录浏览。 幸运的是，如果您无法更改页面或禁用服务器端的目录列表，有一种简单的方法可以遮住这些“假”URL。

要完成此任务，请单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Masks]**。 添加一个蒙版以遮住包含字符`?`的任何URL。 您可以通过输入以下常规任务掩码来执行此表达式:
...
通常，论坛或新闻组会随附自己的搜索引擎。 在这种情况下，您可以使用[!DNL URL Masks]从网站搜索/促销中遮住论坛。

在产品菜单上，单击&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Masks]**。 在[!DNL Staged URL Masks]页面上，通过将论坛的URL输入为排除URL掩码来遮罩论坛。
...
如果您的网站上有PDF文件或[!DNL Microsoft Office]文件，您可能会注意到，仅几个文件的索引大小会计入许多页面。 正在编制索引的页面比您的文档多的原因是，PDF或Microsoft Office文件中的每个页面都计为单独的页面。

在产品菜单上，单击&#x200B;**[!UICONTROL Index]** > **[!UICONTROL Full Index]** > **[!UICONTROL Live Index]**。 在[!DNL Full Index]页面上，选择&#x200B;**[!UICONTROL Count All Pages]**，然后单击&#x200B;**[!UICONTROL Full Index Now]**&#x200B;以查看总页数。 如果不希望对PDF文件或Microsoft Office文件进行索引，可以在&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**&#x200B;下禁用此内容类型。
...
## 您是否超出了网站搜索/促销的内部字节或时间限制？{#section_AE1BE61A58864FFE81F0BCEED2EBB15D}
