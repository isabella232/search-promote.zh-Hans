---
description: 痕迹导航是可添加到网站的导航控件。 痕迹导航可为客户提供关于他们在搜索结果集中的位置的反馈。 它还有助于他们快速退回到上一步。
solution: Target
subtopic: Navigation
title: 关于痕迹导航
...
痕迹导航是可添加到网站的导航控件。 痕迹导航可为客户提供关于他们在搜索结果集中的位置的反馈。 它还有助于他们快速退回到上一步。

## 使用痕迹导航{#concept_FB8A943C594A4A1593B118141DA61F03}

痕迹导航会跟踪搜索的词以及为缩小结果集而选择的后续彩块化。

使用痕迹导航设置可自定义搜索演示层的痕迹导航控制。 如果您的表示层有多个搜索结果集，痕迹导航控件将对页面上的主搜索进行操作。
   ...
   <table> 
    ...
    <tbody> 
      ...
      <ul id="ul_96FCD8E4C3704B45B59BC18A7A1AC52A"> 
        ...
        <li id="li_D848ED44B4E44538AA92010F9F186224"> 拖放 — 将删除整个痕迹导航，使客户在开始向下钻取之前回到该点。 </li> 
      </ul> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>最大值宽度 </p> </td> 
      <td colname="col2"> <p>指定痕迹导航跟踪中每个值的长度。 您将设置指定为多个字符。 </p> <p>例如，设置为6表示痕迹导航跟踪最长可为6个字符，包括空格。 </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>值扩展 </p> </td> 
      <td colname="col2"> <p>指定在截断痕迹导航时要使用的省略号。 </p> <p>默认为“……” （椭圆）。 </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>包括查询条款 </p> </td> 
      <td colname="col2"> <p>控制痕迹导航中是否存在查询项。 </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>启用用户定义的路径 </p> </td> 
      <td colname="col2"> <p>选中后，您可以使用URL中的<span class="codeph"> uX=[name]&amp;[name]=[value] </span>参数在痕迹导航中使用用户定义的项。 您可以使用处理规则按您希望的方式处理此参数。 </p> <p>例如，如果启用此功能，并且您有URL<code> https://search.host.com/?1=category&amp;q1=Clothes&amp;u2= 
          type&amp;type=Men&amp;x3=kind&amp;q3=Sweater </code>，则如果您有facet <span class="codeph"> <span class="varname">类别</span> </span>和<span class="codeph"> <span class="varname">类型</span> </span>，则您的痕迹导航将看起来像<span class="codeph">服装&gt;男士&gt; </span>. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>用户定义的Crumb名称 </p> </td> 
      <td colname="col2"> <p>以逗号分隔的列表，包含用户定义的痕迹导航项的所有可能名称。 </p> <p>仅当选中<span class="uicontrol">启用用户定义的路径</span>时，此选项才可用。 </p> </td> 
      </tr> 
    </tbody> 
    </table>
